...
@WebServlet("/onlineOrderStatusURL")
public class OnlineOrderStatus extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("-----IN order Status Cotroller------> " + request.getParameter("planId"));
		String resp = onlineOrderStatus(request.getParameter("planId"));
	...
	public String onlineOrderStatus(String planId) {
		...
		try {
			...
			String url = "https://integration.training.myopenpay.co.uk/JamServiceImpl.svc/OnlineOrderStatus";
